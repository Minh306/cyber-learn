...
!(function(a, b, c, d) {
  ...
  (e.prototype.initializeItems = function() {
    let b = this.$element.find('.owl-item');
    if (b.length)
      return (
      ...
      'initialized.owl.carousel change.owl.carousel resized.owl.carousel': a.proxy(
        function(b) {
          if (
            ...
            let h = this._core.clones().length;
...
(function(a, b, c, d) {
    ...
    a(b).on(
      ...
      a.proxy(function(a) {
        ...
        let e = this._core.$stage.children();
